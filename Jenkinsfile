pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/chhetrrb'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/ratnac101/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('chhetrrb-225')                                                         //<------your MiamiID
    }
